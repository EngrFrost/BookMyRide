import { PrismaClient, Role, VehicleCategory, VehicleStatus } from '@prisma/client'
...
const vehicles = [
  {
    name: 'Toyota Vios #1',
    category: VehicleCategory.FOUR_SEATER,
    description:
      'Compact sedan, automatic transmission. Fuel-efficient and easy to drive around the city.',
  ...
  },
  {
    ...
    category: VehicleCategory.SEVEN_SEATER,
...
async function main() {
  ...
  // Placeholder admin — linked to a real Firebase UID when first sign-in occurs.
